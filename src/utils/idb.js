...
export async function openDatabase() {
  ...
  return new Promise((resolve, reject) => {
    ...
    openRequest.onerror = (event) => {
      reject("Erreur lors de l'ouverture de la base de données : " + event.target.errorCode)
    }
  })
}
...
export async function getShopLists() {
  ...
  return await new Promise((resolve, reject) => {
    request.onsuccess = () => resolve(request.result)
    request.onerror = () => reject("Erreur lors de la récupération de la liste.")
  })
}
...
export async function addItems(items) {
  ...
  for (const item of items) {
    ...
    const existingItem = await getItemFromIndex(nameIndex, item.name.toLowerCase())
    if (!existingItem) {
...
export async function getItemById(id) {
  ...
  return await new Promise((resolve, reject) => {
    request.onsuccess = () => resolve(request.result)
    request.onerror = () => reject("Erreur lors de la récupération de l'article.")
  })
}
...
export async function updateItem(item) {
  ...
  await new Promise((resolve, reject) => {
    request.onsuccess = () => resolve()
    request.onerror = () => reject("Erreur lors de la mise à jour de l'article.")
  })
...
export async function deleteItem(id) {
  ...
  await new Promise((resolve, reject) => {
    request.onsuccess = () => resolve()
    request.onerror = () => reject("Erreur lors de la suppression de l'article.")
  })
